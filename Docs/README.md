...
Ninety-second, six-world AI performance reel. One performer, six genres, her face holds throughout.
Docs and plans are tracked here; media is not. Independent of the private short film.
...
**Design and rules** — `DIRECTING_SYSTEM.md`, `PROMPT_PATTERN.md`, `PROMPTS_AND_BEATS.md`,
`START_END_FRAME_METHOD.md`, `SEAM_ARCHITECTURE.md`, `CLIP_STRUCTURE.md`, `BEAT_MAP.md`,
`W2_DANCE_GRAMMAR.md`, `DANCE_THEORY_WHAT_READS.md`, `BOLLYWOOD_HIPHOP_FUSION_THEORY.md`,
`MODEL_PROMPT_REGISTERS.md`, `LOOK_BLOCKS_AND_W1_BOARD.md`, `GRADES_SIX_WORLDS.md`.

**Assets and plates** — `ASSET_SPEC.md`, `ASSET_REGISTRY.md`, `ASSET_MANIFEST.md`, `ENVIRONMENT_SPEC.md`,
`LOCATION_PLATES.md`, `PLATE_QA_CARD.md`, `PLATE_W2_INPAINT_BRIEF.md`, `COUTURE_SPEC.md`, `BOARDING_SPEC.md`.

**Music** — `MUSIC_METHOD.md`, `DJ_ARCHITECTURE.md`, `W2_AUDIO_MAP.md`, `OVERLAY_PROMPTS_W2-W6.md`.
